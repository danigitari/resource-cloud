  ...
  <div class="w-screen">
    ...
    <div class="bg-gray-100">
              ...
              <div class="pt-10">
                ...
                >
                  ...
                  >
                    ...
                    students taking IT-related courses can benefit from
                    mastering communication and presentation skills, and the art
                    of personal branding as early.
                  </p>
      ...
      <div class="mt-10 pb-20">
        ...
        <div class="flex flex-wrap max-w-screen">
      ...
      <div class="flex flex-wrap w-screen">
        <div class="lg:w-1/2 w-full lg:px-20 px-4 py-10 flex justify-center">
          <img
            ...
            class="rounded-md w-64 h-64 lg:w-96 lg:h-84"
            alt=""
          />
        </div>
