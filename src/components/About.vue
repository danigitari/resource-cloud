<template>
        ...
        <div class="pt-10">
          ...
          >
            ...
            >
              ...
              taking IT-related courses can benefit from mastering communication
              and presentation skills, and the art of personal branding as
              early.
            </p>
          </div>
        </div>
  ...
  <div class="bg-gray-100 pt-32">
    <div class="flex justify-center">
      <p class="text-2xl font-semibold px-5 pt-10 pb-10 heading">
        Meet The Team
      </p>
    </div>
